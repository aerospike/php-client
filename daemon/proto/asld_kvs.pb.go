...
type ClientPolicy struct {
	...
	AuthMode AuthMode `protobuf:"varint,1,opt,name=AuthMode,proto3,enum=com.aerospike.daemon.AuthMode" json:"AuthMode,omitempty"`
	...
	ClusterName *string `protobuf:"bytes,4,opt,name=ClusterName,proto3,oneof" json:"ClusterName,omitempty"`
	...
	//
	// Default: 0 seconds
	IdleTimeout *uint32 `protobuf:"varint,6,opt,name=IdleTimeout,proto3,oneof" json:"IdleTimeout,omitempty"`
	// LoginTimeout specifies the timeout for login operation for external authentication such as LDAP.
	LoginTimeout *uint32 `protobuf:"varint,7,opt,name=LoginTimeout,proto3,oneof" json:"LoginTimeout,omitempty"`
	...
	ConnectionPoolSize *uint32 `protobuf:"varint,8,opt,name=ConnectionPoolSize,proto3,oneof" json:"ConnectionPoolSize,omitempty"`
	...
	//
	// Default: 0
	MinConnectionsPerNode *uint32 `protobuf:"varint,9,opt,name=MinConnectionsPerNode,proto3,oneof" json:"MinConnectionsPerNode,omitempty"`
	...
	//
	// Default: 100
	MaxErrorRate *uint32 `protobuf:"varint,10,opt,name=MaxErrorRate,proto3,oneof" json:"MaxErrorRate,omitempty"`
	...
	//
	// Default: 1
	ErrorRateWindow *uint32 `protobuf:"varint,11,opt,name=ErrorRateWindow,proto3,oneof" json:"ErrorRateWindow,omitempty"`
	// If set to true, will not create a new connection
	// to the node if there are already `ConnectionQueueSize` active connections.
	// Note: One connection per node is reserved for tend operations and is not used for transactions.
	LimitConnectionsToPoolSize *uint32 `protobuf:"varint,12,opt,name=LimitConnectionsToPoolSize,proto3,oneof" json:"LimitConnectionsToPoolSize,omitempty"`
	...
	OpeningConnectionThreshold *uint32 `protobuf:"varint,13,opt,name=OpeningConnectionThreshold,proto3,oneof" json:"OpeningConnectionThreshold,omitempty"`
	// Throw exception if host connection fails during addHost().
	FailIfNotConnected bool `protobuf:"varint,14,opt,name=FailIfNotConnected,proto3" json:"FailIfNotConnected,omitempty"`
	// TendInterval determines interval for checking for cluster state changes.
	// Minimum possible interval is 10 Milliseconds.
	TendInterval uint32 `protobuf:"varint,15,opt,name=TendInterval,proto3" json:"TendInterval,omitempty"`
	...
	IpMap map[string]string `protobuf:"bytes,16,rep,name=IpMap,proto3" json:"IpMap,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	UseServicesAlternate bool `protobuf:"varint,17,opt,name=UseServicesAlternate,proto3" json:"UseServicesAlternate,omitempty"`
	...
	RackAware bool `protobuf:"varint,18,opt,name=RackAware,proto3" json:"RackAware,omitempty"`
	...
	RackIds []uint32 `protobuf:"varint,19,rep,packed,name=RackIds,proto3" json:"RackIds,omitempty"`
	// IgnoreOtherSubnetAliases helps to ignore aliases that are outside main subnet
	IgnoreOtherSubnetAliases bool `protobuf:"varint,20,opt,name=IgnoreOtherSubnetAliases,proto3" json:"IgnoreOtherSubnetAliases,omitempty"`
	...
	SeedOnlyCluster bool `protobuf:"varint,21,opt,name=SeedOnlyCluster,proto3" json:"SeedOnlyCluster,omitempty"`
}
...
func (x *ClientPolicy) GetAuthMode() AuthMode {
	if x != nil {
		return x.AuthMode
	}
	return AuthMode_AuthModeInternal
}

func (x *ClientPolicy) GetUser() string {
	if x != nil && x.User != nil {
		return *x.User
	}
	return ""
...
func (x *ClientPolicy) GetPassword() string {
...
func (x *ClientPolicy) GetClusterName() string {
...
func (x *ClientPolicy) GetTimeout() uint32 {
...
func (x *ClientPolicy) GetIdleTimeout() uint32 {
...
func (x *ClientPolicy) GetLoginTimeout() uint32 {
	if x != nil && x.LoginTimeout != nil {
		return *x.LoginTimeout
	}
	return 0
}

func (x *ClientPolicy) GetConnectionPoolSize() uint32 {
...
func (x *ClientPolicy) GetMinConnectionsPerNode() uint32 {
	if x != nil && x.MinConnectionsPerNode != nil {
		return *x.MinConnectionsPerNode
	}
	return 0
}

func (x *ClientPolicy) GetMaxErrorRate() uint32 {
	if x != nil && x.MaxErrorRate != nil {
		return *x.MaxErrorRate
	}
	return 0
}

func (x *ClientPolicy) GetErrorRateWindow() uint32 {
	if x != nil && x.ErrorRateWindow != nil {
		return *x.ErrorRateWindow
	}
	return 0
}

func (x *ClientPolicy) GetLimitConnectionsToPoolSize() uint32 {
	if x != nil && x.LimitConnectionsToPoolSize != nil {
		return *x.LimitConnectionsToPoolSize
	}
	return 0
}

func (x *ClientPolicy) GetOpeningConnectionThreshold() uint32 {
	if x != nil && x.OpeningConnectionThreshold != nil {
		return *x.OpeningConnectionThreshold
	}
	return 0
}

func (x *ClientPolicy) GetFailIfNotConnected() bool {
	if x != nil {
		return x.FailIfNotConnected
	}
	return false
}

func (x *ClientPolicy) GetTendInterval() uint32 {
	if x != nil {
		return x.TendInterval
	}
	return 0
}

func (x *ClientPolicy) GetIpMap() map[string]string {
	if x != nil {
		return x.IpMap
	}
	return nil
...
func (x *ClientPolicy) GetUseServicesAlternate() bool {
	if x != nil {
		return x.UseServicesAlternate
	}
	return false
}

func (x *ClientPolicy) GetRackAware() bool {
	if x != nil {
		return x.RackAware
	}
	return false
...
func (x *ClientPolicy) GetRackIds() []uint32 {
	if x != nil {
		return x.RackIds
	}
	return nil
...
func (x *ClientPolicy) GetIgnoreOtherSubnetAliases() bool {
	if x != nil {
		return x.IgnoreOtherSubnetAliases
	}
	return false
}

func (x *ClientPolicy) GetSeedOnlyCluster() bool {
	if x != nil {
		return x.SeedOnlyCluster
	}
	return false
}
...
type ReadPolicy struct {
	...
	// Read policy for AP (availability) namespaces.
	Replica Replica `protobuf:"varint,1,opt,name=replica,proto3,enum=com.aerospike.daemon.Replica" json:"replica,omitempty"`
	// Read policy for SC (strong consistency) namespaces.
...
type BatchWritePolicy struct {
	...
	RecordExistsAction *RecordExistsAction `protobuf:"varint,2,opt,name=RecordExistsAction,proto3,enum=com.aerospike.daemon.RecordExistsAction,oneof" json:"RecordExistsAction,omitempty"`
...
type Value struct {
	...
	Nil  *bool        `protobuf:"varint,1,opt,name=nil,proto3,oneof" json:"nil,omitempty"`
	...
	S    *string      `protobuf:"bytes,4,opt,name=s,proto3,oneof" json:"s,omitempty"`
	...
	L    []*Value     `protobuf:"bytes,7,rep,name=l,proto3" json:"l,omitempty"`
	M    []*MapEntry  `protobuf:"bytes,8,rep,name=m,proto3" json:"m,omitempty"`
	Json []*JsonEntry `protobuf:"bytes,9,rep,name=json,proto3" json:"json,omitempty"`
	Geo  *string      `protobuf:"bytes,10,opt,name=geo,proto3,oneof" json:"geo,omitempty"`
	Hll  []byte       `protobuf:"bytes,11,opt,name=hll,proto3,oneof" json:"hll,omitempty"`
}
...
func (x *Value) GetJson() []*JsonEntry {
	if x != nil {
		return x.Json
	}
	return nil
...
var file_asld_kvs_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x4d, 0x6f, 0x64, 0x65, 0x53,
	0x43, 0x52, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x4d, 0x6f, 0x64, 0x65, 0x53, 0x43, 0x22, 0xca, 0x01,
	0x0a, 0x0b, 0x57, 0x72, 0x69, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x37, 0x0a,
	0x07, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d,
	0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x65, 0x72, 0x6f, 0x73, 0x70, 0x69, 0x6b, 0x65, 0x2e, 0x64,
	0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x52, 0x07, 0x72,
	...
	,
	...
	,
	...
	0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e,
	0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x65, 0x72, 0x6f, 0x73, 0x70, 0x69, 0x6b, 0x65, 0x2e, 0x64, 0x61,
	...
	,
	...
	,
	...
	0x6e, 0x64, 0x4b, 0x65, 0x79, 0x22, 0xae, 0x02, 0x0a, 0x0b, 0x42, 0x61, 0x74, 0x63, 0x68, 0x50,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x38, 0x0a, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18,
	...
	,
	...
	0x2e, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x22, 0x60, 0x0a, 0x08, 0x4d, 0x61, 0x70, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	,
	...
	0x6f, 0x6e, 0x41, 0x72, 0x67, 0x73, 0x22, 0xa1, 0x01, 0x0a, 0x17, 0x41, 0x65, 0x72, 0x6f, 0x73,
	...
	,
	...
	,
	...
	0x6c, 0x6c, 0x10, 0x01, 0x2a, 0x36, 0x0a, 0x08, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79,
	...
	,
	...
	,
	...
	0x10, 0x01, 0x32, 0x9d, 0x0a, 0x0a, 0x03, 0x4b, 0x56, 0x53, 0x12, 0x4f, 0x0a, 0x03, 0x50, 0x75,
	...
	0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x2e, 0x41, 0x65, 0x72, 0x6f, 0x73, 0x70, 0x69, 0x6b, 0x65,
	0x54, 0x72, 0x75, 0x6e, 0x63, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x42, 0x0e, 0x5a, 0x0c, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x3b, 0x70, 0x72, 0x6f,
...
var file_asld_kvs_proto_enumTypes = make([]protoimpl.EnumInfo, 14)
var file_asld_kvs_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_asld_kvs_proto_goTypes = []interface{}{
	(ReadModeAP)(0),                       // 0: com.aerospike.daemon.ReadModeAP
	(ReadModeSC)(0),                       // 1: com.aerospike.daemon.ReadModeSC
	(Replica)(0),                          // 2: com.aerospike.daemon.Replica
	(ConsistencyLevel)(0),                 // 3: com.aerospike.daemon.ConsistencyLevel
	(Priority)(0),                         // 4: com.aerospike.daemon.Priority
	(IndexType)(0),                        // 5: com.aerospike.daemon.IndexType
	(IndexCollectionType)(0),              // 6: com.aerospike.daemon.IndexCollectionType
	(AuthMode)(0),                         // 7: com.aerospike.daemon.AuthMode
	(ListOrderType)(0),                    // 8: com.aerospike.daemon.ListOrderType
	(MapOrderType)(0),                     // 9: com.aerospike.daemon.MapOrderType
	(OperationType)(0),                    // 10: com.aerospike.daemon.OperationType
	(RecordExistsAction)(0),               // 11: com.aerospike.daemon.RecordExistsAction
	(GenerationPolicy)(0),                 // 12: com.aerospike.daemon.GenerationPolicy
	(CommitLevel)(0),                      // 13: com.aerospike.daemon.CommitLevel
	(*ClientPolicy)(nil),                  // 14: com.aerospike.daemon.ClientPolicy
	(*ReadPolicy)(nil),                    // 15: com.aerospike.daemon.ReadPolicy
	(*WritePolicy)(nil),                   // 16: com.aerospike.daemon.WritePolicy
	(*InfoPolicy)(nil),                    // 17: com.aerospike.daemon.InfoPolicy
	(*BatchReadPolicy)(nil),               // 18: com.aerospike.daemon.BatchReadPolicy
	(*BatchWritePolicy)(nil),              // 19: com.aerospike.daemon.BatchWritePolicy
	(*BatchDeletePolicy)(nil),             // 20: com.aerospike.daemon.BatchDeletePolicy
	(*BatchUDFPolicy)(nil),                // 21: com.aerospike.daemon.BatchUDFPolicy
	(*BatchPolicy)(nil),                   // 22: com.aerospike.daemon.BatchPolicy
	(*Bin)(nil),                           // 23: com.aerospike.daemon.Bin
	(*MapEntry)(nil),                      // 24: com.aerospike.daemon.MapEntry
	(*JsonEntry)(nil),                     // 25: com.aerospike.daemon.JsonEntry
	(*Value)(nil),                         // 26: com.aerospike.daemon.Value
	(*Key)(nil),                           // 27: com.aerospike.daemon.Key
	(*Record)(nil),                        // 28: com.aerospike.daemon.Record
	(*Error)(nil),                         // 29: com.aerospike.daemon.Error
	(*BatchRecord)(nil),                   // 30: com.aerospike.daemon.BatchRecord
	(*CDTContext)(nil),                    // 31: com.aerospike.daemon.CDTContext
	(*Operation)(nil),                     // 32: com.aerospike.daemon.Operation
	(*BatchWrite)(nil),                    // 33: com.aerospike.daemon.BatchWrite
	(*BatchRead)(nil),                     // 34: com.aerospike.daemon.BatchRead
	(*BatchDelete)(nil),                   // 35: com.aerospike.daemon.BatchDelete
	(*BatchUDF)(nil),                      // 36: com.aerospike.daemon.BatchUDF
	(*AerospikeSingleResponse)(nil),       // 37: com.aerospike.daemon.AerospikeSingleResponse
	(*AerospikeGetRequest)(nil),           // 38: com.aerospike.daemon.AerospikeGetRequest
	(*AerospikeGetHeaderRequest)(nil),     // 39: com.aerospike.daemon.AerospikeGetHeaderRequest
	(*AerospikeExistsRequest)(nil),        // 40: com.aerospike.daemon.AerospikeExistsRequest
	(*AerospikeExistsResponse)(nil),       // 41: com.aerospike.daemon.AerospikeExistsResponse
	(*AerospikeDeleteRequest)(nil),        // 42: com.aerospike.daemon.AerospikeDeleteRequest
	(*AerospikeDeleteResponse)(nil),       // 43: com.aerospike.daemon.AerospikeDeleteResponse
	(*AerospikeTouchRequest)(nil),         // 44: com.aerospike.daemon.AerospikeTouchRequest
	(*AerospikePutRequest)(nil),           // 45: com.aerospike.daemon.AerospikePutRequest
	(*BatchOperate)(nil),                  // 46: com.aerospike.daemon.BatchOperate
	(*AerospikeBatchOperateRequest)(nil),  // 47: com.aerospike.daemon.AerospikeBatchOperateRequest
	(*AerospikeBatchOperateResponse)(nil), // 48: com.aerospike.daemon.AerospikeBatchOperateResponse
	(*AerospikeCreateIndexRequest)(nil),   // 49: com.aerospike.daemon.AerospikeCreateIndexRequest
	(*AerospikeCreateIndexResponse)(nil),  // 50: com.aerospike.daemon.AerospikeCreateIndexResponse
	(*AerospikeDropIndexRequest)(nil),     // 51: com.aerospike.daemon.AerospikeDropIndexRequest
	(*AerospikeDropIndexResponse)(nil),    // 52: com.aerospike.daemon.AerospikeDropIndexResponse
	(*AerospikeTruncateRequest)(nil),      // 53: com.aerospike.daemon.AerospikeTruncateRequest
	(*AerospikeTruncateResponse)(nil),     // 54: com.aerospike.daemon.AerospikeTruncateResponse
	(*BackgroundExecutePolicy)(nil),       // 55: com.aerospike.daemon.BackgroundExecutePolicy
	nil,                                   // 56: com.aerospike.daemon.ClientPolicy.IpMapEntry
	nil,                                   // 57: com.aerospike.daemon.Record.BinsEntry
}
var file_asld_kvs_proto_depIdxs = []int32{
	7,  // 0: com.aerospike.daemon.ClientPolicy.AuthMode:type_name -> com.aerospike.daemon.AuthMode
	56, // 1: com.aerospike.daemon.ClientPolicy.IpMap:type_name -> com.aerospike.daemon.ClientPolicy.IpMapEntry
	2,  // 2: com.aerospike.daemon.ReadPolicy.replica:type_name -> com.aerospike.daemon.Replica
	0,  // 3: com.aerospike.daemon.ReadPolicy.readModeAP:type_name -> com.aerospike.daemon.ReadModeAP
	1,  // 4: com.aerospike.daemon.ReadPolicy.readModeSC:type_name -> com.aerospike.daemon.ReadModeSC
	2,  // 5: com.aerospike.daemon.WritePolicy.replica:type_name -> com.aerospike.daemon.Replica
	0,  // 6: com.aerospike.daemon.WritePolicy.readModeAP:type_name -> com.aerospike.daemon.ReadModeAP
	1,  // 7: com.aerospike.daemon.WritePolicy.readModeSC:type_name -> com.aerospike.daemon.ReadModeSC
	0,  // 8: com.aerospike.daemon.BatchReadPolicy.readModeAP:type_name -> com.aerospike.daemon.ReadModeAP
	1,  // 9: com.aerospike.daemon.BatchReadPolicy.readModeSC:type_name -> com.aerospike.daemon.ReadModeSC
	11, // 10: com.aerospike.daemon.BatchWritePolicy.RecordExistsAction:type_name -> com.aerospike.daemon.RecordExistsAction
	13, // 11: com.aerospike.daemon.BatchWritePolicy.commitLevel:type_name -> com.aerospike.daemon.CommitLevel
	12, // 12: com.aerospike.daemon.BatchWritePolicy.generationPolicy:type_name -> com.aerospike.daemon.GenerationPolicy
	13, // 13: com.aerospike.daemon.BatchDeletePolicy.commitLevel:type_name -> com.aerospike.daemon.CommitLevel
	12, // 14: com.aerospike.daemon.BatchDeletePolicy.generationPolicy:type_name -> com.aerospike.daemon.GenerationPolicy
	13, // 15: com.aerospike.daemon.BatchUDFPolicy.commitLevel:type_name -> com.aerospike.daemon.CommitLevel
	15, // 16: com.aerospike.daemon.BatchPolicy.policy:type_name -> com.aerospike.daemon.ReadPolicy
	26, // 17: com.aerospike.daemon.Bin.value:type_name -> com.aerospike.daemon.Value
	26, // 18: com.aerospike.daemon.MapEntry.k:type_name -> com.aerospike.daemon.Value
	26, // 19: com.aerospike.daemon.MapEntry.v:type_name -> com.aerospike.daemon.Value
	26, // 20: com.aerospike.daemon.JsonEntry.v:type_name -> com.aerospike.daemon.Value
	26, // 21: com.aerospike.daemon.Value.l:type_name -> com.aerospike.daemon.Value
	24, // 22: com.aerospike.daemon.Value.m:type_name -> com.aerospike.daemon.MapEntry
	25, // 23: com.aerospike.daemon.Value.json:type_name -> com.aerospike.daemon.JsonEntry
	26, // 24: com.aerospike.daemon.Key.value:type_name -> com.aerospike.daemon.Value
	27, // 25: com.aerospike.daemon.Record.key:type_name -> com.aerospike.daemon.Key
	57, // 26: com.aerospike.daemon.Record.Bins:type_name -> com.aerospike.daemon.Record.BinsEntry
	27, // 27: com.aerospike.daemon.BatchRecord.key:type_name -> com.aerospike.daemon.Key
	28, // 28: com.aerospike.daemon.BatchRecord.record:type_name -> com.aerospike.daemon.Record
	29, // 29: com.aerospike.daemon.BatchRecord.error:type_name -> com.aerospike.daemon.Error
	26, // 30: com.aerospike.daemon.CDTContext.value:type_name -> com.aerospike.daemon.Value
	10, // 31: com.aerospike.daemon.Operation.opType:type_name -> com.aerospike.daemon.OperationType
	31, // 32: com.aerospike.daemon.Operation.ctx:type_name -> com.aerospike.daemon.CDTContext
	26, // 33: com.aerospike.daemon.Operation.binValue:type_name -> com.aerospike.daemon.Value
	30, // 34: com.aerospike.daemon.BatchWrite.batchRecord:type_name -> com.aerospike.daemon.BatchRecord
	19, // 35: com.aerospike.daemon.BatchWrite.policy:type_name -> com.aerospike.daemon.BatchWritePolicy
	32, // 36: com.aerospike.daemon.BatchWrite.ops:type_name -> com.aerospike.daemon.Operation
	30, // 37: com.aerospike.daemon.BatchRead.batchRecord:type_name -> com.aerospike.daemon.BatchRecord
	18, // 38: com.aerospike.daemon.BatchRead.policy:type_name -> com.aerospike.daemon.BatchReadPolicy
	32, // 39: com.aerospike.daemon.BatchRead.ops:type_name -> com.aerospike.daemon.Operation
	30, // 40: com.aerospike.daemon.BatchDelete.batchRecord:type_name -> com.aerospike.daemon.BatchRecord
	20, // 41: com.aerospike.daemon.BatchDelete.policy:type_name -> com.aerospike.daemon.BatchDeletePolicy
	30, // 42: com.aerospike.daemon.BatchUDF.batchRecord:type_name -> com.aerospike.daemon.BatchRecord
	21, // 43: com.aerospike.daemon.BatchUDF.policy:type_name -> com.aerospike.daemon.BatchUDFPolicy
	26, // 44: com.aerospike.daemon.BatchUDF.functionArgs:type_name -> com.aerospike.daemon.Value
	29, // 45: com.aerospike.daemon.AerospikeSingleResponse.error:type_name -> com.aerospike.daemon.Error
	28, // 46: com.aerospike.daemon.AerospikeSingleResponse.record:type_name -> com.aerospike.daemon.Record
	15, // 47: com.aerospike.daemon.AerospikeGetRequest.policy:type_name -> com.aerospike.daemon.ReadPolicy
	27, // 48: com.aerospike.daemon.AerospikeGetRequest.key:type_name -> com.aerospike.daemon.Key
	15, // 49: com.aerospike.daemon.AerospikeGetHeaderRequest.policy:type_name -> com.aerospike.daemon.ReadPolicy
	27, // 50: com.aerospike.daemon.AerospikeGetHeaderRequest.key:type_name -> com.aerospike.daemon.Key
	15, // 51: com.aerospike.daemon.AerospikeExistsRequest.policy:type_name -> com.aerospike.daemon.ReadPolicy
	27, // 52: com.aerospike.daemon.AerospikeExistsRequest.key:type_name -> com.aerospike.daemon.Key
	29, // 53: com.aerospike.daemon.AerospikeExistsResponse.error:type_name -> com.aerospike.daemon.Error
	16, // 54: com.aerospike.daemon.AerospikeDeleteRequest.policy:type_name -> com.aerospike.daemon.WritePolicy
	27, // 55: com.aerospike.daemon.AerospikeDeleteRequest.key:type_name -> com.aerospike.daemon.Key
	29, // 56: com.aerospike.daemon.AerospikeDeleteResponse.error:type_name -> com.aerospike.daemon.Error
	16, // 57: com.aerospike.daemon.AerospikeTouchRequest.policy:type_name -> com.aerospike.daemon.WritePolicy
	27, // 58: com.aerospike.daemon.AerospikeTouchRequest.key:type_name -> com.aerospike.daemon.Key
	16, // 59: com.aerospike.daemon.AerospikePutRequest.policy:type_name -> com.aerospike.daemon.WritePolicy
	27, // 60: com.aerospike.daemon.AerospikePutRequest.key:type_name -> com.aerospike.daemon.Key
	23, // 61: com.aerospike.daemon.AerospikePutRequest.Bins:type_name -> com.aerospike.daemon.Bin
	34, // 62: com.aerospike.daemon.BatchOperate.br:type_name -> com.aerospike.daemon.BatchRead
	33, // 63: com.aerospike.daemon.BatchOperate.bw:type_name -> com.aerospike.daemon.BatchWrite
	35, // 64: com.aerospike.daemon.BatchOperate.bd:type_name -> com.aerospike.daemon.BatchDelete
	36, // 65: com.aerospike.daemon.BatchOperate.bu:type_name -> com.aerospike.daemon.BatchUDF
	22, // 66: com.aerospike.daemon.AerospikeBatchOperateRequest.policy:type_name -> com.aerospike.daemon.BatchPolicy
	46, // 67: com.aerospike.daemon.AerospikeBatchOperateRequest.records:type_name -> com.aerospike.daemon.BatchOperate
	29, // 68: com.aerospike.daemon.AerospikeBatchOperateResponse.error:type_name -> com.aerospike.daemon.Error
	30, // 69: com.aerospike.daemon.AerospikeBatchOperateResponse.records:type_name -> com.aerospike.daemon.BatchRecord
	16, // 70: com.aerospike.daemon.AerospikeCreateIndexRequest.policy:type_name -> com.aerospike.daemon.WritePolicy
	5,  // 71: com.aerospike.daemon.AerospikeCreateIndexRequest.indexType:type_name -> com.aerospike.daemon.IndexType
	6,  // 72: com.aerospike.daemon.AerospikeCreateIndexRequest.indexCollectionType:type_name -> com.aerospike.daemon.IndexCollectionType
	31, // 73: com.aerospike.daemon.AerospikeCreateIndexRequest.ctx:type_name -> com.aerospike.daemon.CDTContext
	29, // 74: com.aerospike.daemon.AerospikeCreateIndexResponse.error:type_name -> com.aerospike.daemon.Error
	16, // 75: com.aerospike.daemon.AerospikeDropIndexRequest.policy:type_name -> com.aerospike.daemon.WritePolicy
	29, // 76: com.aerospike.daemon.AerospikeDropIndexResponse.error:type_name -> com.aerospike.daemon.Error
	17, // 77: com.aerospike.daemon.AerospikeTruncateRequest.policy:type_name -> com.aerospike.daemon.InfoPolicy
	29, // 78: com.aerospike.daemon.AerospikeTruncateResponse.error:type_name -> com.aerospike.daemon.Error
	2,  // 79: com.aerospike.daemon.BackgroundExecutePolicy.replica:type_name -> com.aerospike.daemon.Replica
	0,  // 80: com.aerospike.daemon.BackgroundExecutePolicy.readModeAP:type_name -> com.aerospike.daemon.ReadModeAP
	1,  // 81: com.aerospike.daemon.BackgroundExecutePolicy.readModeSC:type_name -> com.aerospike.daemon.ReadModeSC
	11, // 82: com.aerospike.daemon.BackgroundExecutePolicy.recordExistsAction:type_name -> com.aerospike.daemon.RecordExistsAction
	12, // 83: com.aerospike.daemon.BackgroundExecutePolicy.generationPolicy:type_name -> com.aerospike.daemon.GenerationPolicy
	13, // 84: com.aerospike.daemon.BackgroundExecutePolicy.commitLevel:type_name -> com.aerospike.daemon.CommitLevel
	26, // 85: com.aerospike.daemon.Record.BinsEntry.value:type_name -> com.aerospike.daemon.Value
	45, // 86: com.aerospike.daemon.KVS.Put:input_type -> com.aerospike.daemon.AerospikePutRequest
	45, // 87: com.aerospike.daemon.KVS.Add:input_type -> com.aerospike.daemon.AerospikePutRequest
	45, // 88: com.aerospike.daemon.KVS.Append:input_type -> com.aerospike.daemon.AerospikePutRequest
	45, // 89: com.aerospike.daemon.KVS.Prepend:input_type -> com.aerospike.daemon.AerospikePutRequest
	38, // 90: com.aerospike.daemon.KVS.Get:input_type -> com.aerospike.daemon.AerospikeGetRequest
	39, // 91: com.aerospike.daemon.KVS.GetHeader:input_type -> com.aerospike.daemon.AerospikeGetHeaderRequest
	40, // 92: com.aerospike.daemon.KVS.Exists:input_type -> com.aerospike.daemon.AerospikeExistsRequest
	42, // 93: com.aerospike.daemon.KVS.Delete:input_type -> com.aerospike.daemon.AerospikeDeleteRequest
	44, // 94: com.aerospike.daemon.KVS.Touch:input_type -> com.aerospike.daemon.AerospikeTouchRequest
	47, // 95: com.aerospike.daemon.KVS.BatchOperate:input_type -> com.aerospike.daemon.AerospikeBatchOperateRequest
	49, // 96: com.aerospike.daemon.KVS.CreateIndex:input_type -> com.aerospike.daemon.AerospikeCreateIndexRequest
	51, // 97: com.aerospike.daemon.KVS.DropIndex:input_type -> com.aerospike.daemon.AerospikeDropIndexRequest
	53, // 98: com.aerospike.daemon.KVS.Truncate:input_type -> com.aerospike.daemon.AerospikeTruncateRequest
	29, // 99: com.aerospike.daemon.KVS.Put:output_type -> com.aerospike.daemon.Error
	29, // 100: com.aerospike.daemon.KVS.Add:output_type -> com.aerospike.daemon.Error
	29, // 101: com.aerospike.daemon.KVS.Append:output_type -> com.aerospike.daemon.Error
	29, // 102: com.aerospike.daemon.KVS.Prepend:output_type -> com.aerospike.daemon.Error
	37, // 103: com.aerospike.daemon.KVS.Get:output_type -> com.aerospike.daemon.AerospikeSingleResponse
	37, // 104: com.aerospike.daemon.KVS.GetHeader:output_type -> com.aerospike.daemon.AerospikeSingleResponse
	41, // 105: com.aerospike.daemon.KVS.Exists:output_type -> com.aerospike.daemon.AerospikeExistsResponse
	43, // 106: com.aerospike.daemon.KVS.Delete:output_type -> com.aerospike.daemon.AerospikeDeleteResponse
	29, // 107: com.aerospike.daemon.KVS.Touch:output_type -> com.aerospike.daemon.Error
	48, // 108: com.aerospike.daemon.KVS.BatchOperate:output_type -> com.aerospike.daemon.AerospikeBatchOperateResponse
	50, // 109: com.aerospike.daemon.KVS.CreateIndex:output_type -> com.aerospike.daemon.AerospikeCreateIndexResponse
	52, // 110: com.aerospike.daemon.KVS.DropIndex:output_type -> com.aerospike.daemon.AerospikeDropIndexResponse
	54, // 111: com.aerospike.daemon.KVS.Truncate:output_type -> com.aerospike.daemon.AerospikeTruncateResponse
...
func file_asld_kvs_proto_init() {
	...
	file_asld_kvs_proto_msgTypes[12].OneofWrappers = []interface{}{}
	file_asld_kvs_proto_msgTypes[13].OneofWrappers = []interface{}{}
	...
	file_asld_kvs_proto_msgTypes[29].OneofWrappers = []interface{}{}
