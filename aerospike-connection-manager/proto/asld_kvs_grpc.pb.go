...
const (
	KVS_Version_FullMethodName          = "/com.aerospike.daemon.KVS/Version"
...
type KVSClient interface {
	Version(ctx context.Context, in *AerospikeVersionRequest, opts ...grpc.CallOption) (*AerospikeVersionResponse, error)
	// Put a single record
...
func (c *kVSClient) Version(ctx context.Context, in *AerospikeVersionRequest, opts ...grpc.CallOption) (*AerospikeVersionResponse, error) {
	out := new(AerospikeVersionResponse)
	err := c.cc.Invoke(ctx, KVS_Version_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KVSServer interface {
	Version(context.Context, *AerospikeVersionRequest) (*AerospikeVersionResponse, error)
	// Put a single record
...
func (UnimplementedKVSServer) Version(context.Context, *AerospikeVersionRequest) (*AerospikeVersionResponse, error) {
...
func _KVS_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AerospikeVersionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVSServer).Version(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KVS_Version_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVSServer).Version(ctx, req.(*AerospikeVersionRequest))
	}
